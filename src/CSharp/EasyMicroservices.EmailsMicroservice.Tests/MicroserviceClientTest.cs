...
namespace EasyMicroservices.EmailsMicroservice.Clients.Tests
{
...
{""result"":[],""isSuccess"":true,""error"":null}");
        ...
        {
            //await OnInitialize();
            //var microserviceClient = new Emails.GeneratedServices.MicroserviceClient(_routeAddress, HttpClient);
